...
import com.android.zahra.zahra_1202150246_modul6.activity.AddPhotoActivity;
...
import com.android.zahra.zahra_1202150246_modul6.config.Constant;
import com.android.zahra.zahra_1202150246_modul6.fragment.PhotoFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentStatePagerItemAdapter adapter = new FragmentStatePagerItemAdapter(
                ...
                .add(FragmentPagerItem.of("HOME", PhotoFragment.class, PhotoFragment.arguments("terbaru")))
                .add(FragmentPagerItem.of("MY POST", PhotoFragment.class, PhotoFragment.arguments("fotosaya")))
                .create());
